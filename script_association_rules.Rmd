...
De notar que a utilização desta métrica obriga a manter uma matriz NxN em memória, o que muito rapidamente se torna significativo, pelo que apenas consideramos um subconjunto dos dados.  
...
# Conclusão
Os dados de origem utilizados não permitem obter resultados muito satisfatórios, visto que estes não permitem a criação de clusters suficientemente distintos entre si, dificultado ainda pela presença de dados categórios. 
Os agrupamentos criados com base no *RFM Score* sofrem também deste problema. No entanto, um resultado que está de acordo com esta escolha é a quantidade de produtos com suporte mínimo mais elevado. Por exemplo, com suporte mínimo de 20%, o clusters dos clientes do tipo frequente tem o dobro do que o cluster de clientes do tipo regular.
