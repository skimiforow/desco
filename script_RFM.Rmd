...
df_card$HasChildren <- factor(df_card$HasChildren, levels = c("TRUE","FALSE"),labels = c("Sim","Nï¿½o"))
df_card$Responded <- factor(df_card$Responded, levels = c("TRUE","FALSE"),labels = c("Sim","Nï¿½o"))
...
#3. Criaï¿½ï¿½o de modelos de Data-Mining
