...
### Tratar os dados nulos e errados nas colunas NumChildren e YoungestChild , pois tem valores negativos. No MaritialStatus a dados nulos que devem ser tratados também.
...
card$HasChildren[card$YoungestChild==0]<-'N'
