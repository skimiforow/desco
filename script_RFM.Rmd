...
# Data normalization
df_data <- scale(df_card[, df_card$Gender])
...
pcenter <- attr(df_data, "scaled:center")
pscale <- attr(df_data, "scaled:scale")

# Transformar a matriz num data frame
df_data <- data.frame(scale(df_card[,-1]))
