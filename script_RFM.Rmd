...
df_card$HasChildren <- factor(df_card$HasChildren, levels = c("N","Y"),labels = c("N�o","Sim"))
...
# Verificar a percentagem de clientes que disseram que sim ou que n�o � campanha
