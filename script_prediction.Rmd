...
# Alterar o RFM para dados categoricos para avaliação
...
rfm_score_cat <- case_when(df_card$rfm_score <= 65 ~ 'Young-Old',
                  between(df_card$rfm_score, 66, 75) ~ 'Med-Old',
                  df_card$rfm_score >= 86 ~ 'Old-Old'
                  )

df_card <- rbind(df_card,rfm_score_cat)
