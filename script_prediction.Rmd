...
resutls.df <- rbind(resutls.df,allcrosstabmeasures(test_Labels,svpredradial,"Support Vector Machine (SVM) - Radial"))
...
resutls.df <- rbind(resutls.df,allcrosstabmeasures(test_Labels,nnpred,"Neural network"))
